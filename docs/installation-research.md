...
The checkout is the content owner. Installation creates four absolute symlinks and a small ownership manifest under `CODEX_HOME/.codex-swe-harness/`. The manifest contains paths only; it does not copy instruction or skill content.
